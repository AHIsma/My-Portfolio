...
import { Language, Facebook, LinkedIn, Instagram } from "@material-ui/icons";
                ...
                <TabPanel value={value} index={elem.id} key={elem.id}>
                    <Box mb={4}>
                        <Typography variant="h5">
                            ...
                            <Link
                                href={elem.links.website || elem.links.facebook || elem.links.instagram || elem.links.instagram}
                                color="primary"
                            >
                                {elem.company}
                            </Link>
                    ...
                    <Box mb={4}>
                        <Typography style={{whiteSpace: "pre-line"}} variant="body1" color="textPrimary">
